...
$im.rectangle(location => ( 90, 110), size => (20, 20), fill => True , color => $red);
$im.setThickness(3);
...
my $ref = $*PROGRAM.sibling("data/030-thickness.html").IO.slurp;
ok $test eq $ref;
...
030-thickness.raku - draw lines, rectangles and ellipses with various thicknesses

=head1 SYNOPSIS

  raku -I. xt/030-thickness.raku

=head1 DESCRIPTION

This program creates a picture showing lines (various colours, various
